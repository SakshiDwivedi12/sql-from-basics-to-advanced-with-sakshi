# sql-from-basics-to-advanced-with-sakshi
This repository showcases my SQL learning journey, covering fundamentals to advanced concepts including complex queries, joins, subqueries, window functions, and performance optimization. It includes hands-on projects focused on real-world data analysis, analytics, and enterprise-style database use cases.
About This Repository
This repository documents my end-to-end SQL learning journey, focused on building strong fundamentals and advanced, real-world SQL skills through hands-on practice and projects.
...
Creating and managing database objects using CREATE, ALTER, DROP
Inserting, updating, and deleting data using INSERT, UPDATE, DELETE
Filtering & Data Transformation
Using operators: AND, OR, NOT, IN, BETWEEN, LIKE
Applying string, numeric, date, and NULL-handling functions
Writing conditional logic using CASE expressions
Combining & Analyzing Data
Multi-table analysis using INNER, LEFT, RIGHT, FULL, and CROSS joins
...
Software developers optimizing database performance
Data scientists using SQL for analysis and insights
